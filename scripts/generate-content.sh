...
# Uses research skill primary sources (no hallucination) + spec-driven narrative
cat docs/research-deep-analytics.md docs/research-unsupervised.md > /tmp/src_for_content.md
